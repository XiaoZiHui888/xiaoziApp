     ...
     <View style={styles.header}>
       <ImageBackground style={styles.card} source={require("../../assets/card_bg2.png")}>
         ...
         <View style={styles.cardMid}>
           ...
           <Text style={styles.cardMidText3}>使用时间:9:00-22:00</Text>
         </View>
         <View style={styles.cardRight}>
           <Text style={styles.cardRightText1}>每日限额50000</Text>
           <Text style={styles.cardRightText2}>单笔限额50000</Text>
         </View>
       </ImageBackground>
    ...
    return (
      <View style={styles.page}>
        ...
        <View style={styles.list}>
          ...
          {this.renderCell('收款银行',this.state.bankName,this.onSelectBank.bind(this))}
        ...
        <Image style={styles.footerImage} source={require("../../assets/text1.png")}></Image>
      </View>
    );
  }
